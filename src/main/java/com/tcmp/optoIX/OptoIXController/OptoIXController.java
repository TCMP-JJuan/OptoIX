package com.tcmp.optoIX.OptoIXController;
...
@RequestMapping("/optoix")
public class OptoIXController {
    ...
    public ResponseEntity<String> startFlow() {
        ...
        headers.add("Content-Disposition", "attachment; filename=optoix.csv");
